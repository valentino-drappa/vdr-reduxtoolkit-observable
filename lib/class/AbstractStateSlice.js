    ...
    get slice() {
        if (!this._slice) {
            this._slice = toolkit_1.createSlice({
                ...
                reducers: Object.assign(Object.assign({}, this._singleReducers.reduce((prev, next) => Object.assign(prev, { [next.actionName]: next.reduce }), {})), this._epicReducers.map((x) => x.reducers).reduce((prev, next) => Object.assign(prev, next), {})),
            });
        }
        return this._slice;
    }
